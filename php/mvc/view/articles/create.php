...
<div class="mainConteiner" role="main">
    ...
    <form method="post" class="form" action="articles/create">
        <div class="createArticle">Formulaire de création d'article</div>
        <input class="marginForm titleSize" type="text" name="title" placeholder="Titre de l'article"><br><br>
        <textarea class="marginForm textArea" name="content"  placeholder="Contenu de l'article"></textarea><br>
